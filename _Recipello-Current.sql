...
--
-- Host: 127.0.0.1
-- Czas generowania: 17 Wrz 2023, 20:53
...
(1, 'Spaghetti Aglio e Olio', 'Italian, Pasta', 0, 1, 30, 'spaghetti, garlic, olive oil, red pepper flakes, parsley', 1, '1. Cook spaghetti. 2. Sauté garlic in olive oil. 3. Add red pepper flakes and parsley. 4. Toss with spaghetti.', 'C:\\xampp\\htdocs\\uploads\\Spahgetti_aglio.jpg'),
(2, 'Paella', 'Spanish, Seafood', 0, 1, 60, 'rice, chicken, shrimp, bell peppers, saffron', 2, '1. Sauté chicken and shrimp. 2. Add rice, peppers, and saffron. 3. Cook until rice is done.', 'C:\\xampp\\htdocs\\uploads\\paella.jpg\n'),
(3, 'Croissant', 'French, Bakery', 0, 0, 120, 'flour, butter, sugar, yeast, salt', 3, '1. Mix ingredients. 2. Fold and roll dough. 3. Bake for flaky croissants.', 'C:\\xampp\\htdocs\\uploads\\croissant.jpg'),
(4, 'Fish and Chips', 'British, Seafood', 0, 1, 45, 'fish fillets, potatoes, flour, beer, tartar sauce', 4, '1. Batter fish. 2. Fry with potatoes. 3. Serve with tartar sauce.', 'C:\\xampp\\htdocs\\uploads\\fish-and-chips-recipe.jpg'),
(5, 'Bratwurst with Sauerkraut', 'German, Sausage', 0, 0, 60, 'bratwurst, sauerkraut, onions, mustard', 5, '1. Grill bratwurst. 2. Serve with sauerkraut, onions, and mustard.', 'C:\\xampp\\htdocs\\uploads\\Bratwurst.jpg'),
(6, 'Pierogi', 'Polish, Dumplings', 0, 1, 90, 'dough, potatoes, cheese, onions, butter', 6, '1. Make dough and filling. 2. Shape into dumplings. 3. Boil and sauté with butter.', 'C:\\xampp\\htdocs\\uploads\\pierogi.jpg'),
(7, 'Caprese Salad', 'Italian, Salad', 1, 1, 15, 'tomatoes, mozzarella, basil, olive oil, balsamic vinegar', 1, '1. Slice tomatoes and mozzarella. 2. Layer with basil. 3. Drizzle with oil and vinegar.', 'C:\\xampp\\htdocs\\uploads\\caprese.jpg'),
(8, 'Pad Thai', 'Thai, Noodles', 1, 1, 30, 'rice noodles, tofu, peanuts, bean sprouts, tamarind sauce', 2, '1. Stir-fry tofu and noodles. 2. Add sauce and toppings. 3. Enjoy Pad Thai.', 'C:\\xampp\\htdocs\\uploads\\pad_thai.jpg'),
(9, 'Chana Masala', 'Indian, Curry', 1, 1, 45, 'chickpeas, tomatoes, onions, spices, cilantro', 3, '1. Sauté onions and spices. 2. Add chickpeas and tomatoes. 3. Garnish with cilantro.', 'C:\\xampp\\htdocs\\uploads\\chana.jpg'),
(10, 'Turkish Kebab', 'Turkish, Kebab', 0, 1, 60, 'lamb, onions, yogurt, pita bread, spices', 4, '1. Grill lamb. 2. Serve in pita with yogurt and spices.', 'C:\\xampp\\htdocs\\uploads\\kebab.jpg'),
(11, 'Sushi Rolls', 'Japanese, Sushi', 0, 1, 60, 'sushi rice, nori, fish, vegetables, soy sauce', 5, '1. Roll ingredients in nori. 2. Slice into rolls. 3. Dip in soy sauce.', 'C:\\xampp\\htdocs\\uploads\\sushi.jpg'),
(12, 'Cheeseburger', 'American, Burger', 0, 1, 30, 'beef patty, cheese, lettuce, tomato, bun', 6, '1. Grill patty. 2. Assemble burger with toppings. 3. Serve in a bun.', 'C:\\xampp\\htdocs\\uploads\\cheesburger.jpg'),
(13, 'Margherita Pizza', 'Italian, Pizza', 0, 1, 45, 'pizza dough, tomato sauce, mozzarella cheese, basil', 1, '1. Top dough with sauce, cheese, and basil. 2. Bake for a classic pizza.', 'C:\\xampp\\htdocs\\uploads\\pizza.jpg'),
(14, 'Crème Brûlée', 'French, Dessert', 0, 0, 90, 'heavy cream, sugar, eggs, vanilla, caramelized sugar', 2, '1. Mix ingredients. 2. Bake and caramelize sugar for a creamy dessert.', 'C:\\xampp\\htdocs\\uploads\\creme.jpg'),
(15, 'Kimchi Fried Rice', 'Korean, Fried Rice', 1, 1, 30, 'rice, kimchi, vegetables, soy sauce, fried egg', 3, '1. Fry rice with kimchi and veggies. 2. Top with a fried egg. 3. Drizzle soy sauce.', 'C:\\xampp\\htdocs\\uploads\\kimchi.jpg'),
(16, 'Jollof Rice', 'African, Rice', 0, 1, 60, 'rice, tomatoes, onions, peppers, spices', 4, '1. Sauté onions and spices. 2. Add rice and tomatoes. 3. Cook until tender.', 'C:\\xampp\\htdocs\\uploads\\jollof.jpg'),
(17, 'Irish Stew', 'Irish, Stew', 0, 0, 120, 'lamb, potatoes, carrots, onions, herbs', 31, '1. Cook lamb with veggies and herbs. 2. Simmer for a hearty stew.', 'C:\\xampp\\htdocs\\uploads\\irish_stew.jpg'),
(18, 'Swedish Meatballs', 'Swedish, Meatballs', 0, 0, 45, 'ground beef, breadcrumbs, onions, cream sauce', 6, '1. Make meatballs. 2. Serve with cream sauce for a Swedish favorite.', 'C:\\xampp\\htdocs\\uploads\\meatballs.jpg'),
(19, 'California Roll', 'Japanese, Sushi', 0, 1, 60, 'sushi rice, nori, crab meat, avocado, cucumber', 1, '1. Roll ingredients in nori. 2. Slice into rolls. 3. Enjoy with soy sauce.', 'C:\\xampp\\htdocs\\uploads\\california.jpg'),
(20, 'Chocolate Brownies', 'Dessert, Brownies', 1, 0, 45, 'chocolate, butter, sugar, eggs, flour', 2, '1. Mix ingredients. 2. Bake for delicious chocolate brownies.', 'C:\\xampp\\htdocs\\uploads\\brownie.jpg'),
(21, 'Vegan Tofu Stir-Fry', 'Vegan, Stir-Fry', 1, 0, 30, 'tofu, vegetables, soy sauce, rice', 1, '1. Press tofu, cut into cubes. 2. Stir-fry tofu and veggies. 3. Add soy sauce. 4. Serve with rice.', 'C:\\xampp\\htdocs\\uploads\\tofu_stir fry.jpg'),
(22, 'Mediterranean Salad', 'Salad, Mediterranean', 1, 1, 15, 'cucumbers, tomatoes, olives, feta cheese, olive oil', 2, '1. Chop veggies. 2. Mix with olive oil. 3. Add feta cheese. 4. Enjoy as a refreshing salad.', 'C:\\xampp\\htdocs\\uploads\\Mediterranean.jpg'),
(23, 'Spicy Chicken Tacos', 'Tacos, Spicy', 0, 1, 30, 'chicken, tortillas, salsa, sour cream, lettuce', 3, '1. Grill chicken. 2. Assemble tacos with salsa and sour cream. 3. Serve with lettuce.', 'C:\\xampp\\htdocs\\uploads\\tacos.jpg'),
(24, 'Vegetable Fried Rice', 'Fried Rice, Vegetarian', 1, 1, 45, 'rice, mixed vegetables, soy sauce', 4, '1. Cook rice. 2. Stir-fry veggies. 3. Add soy sauce. 4. Combine for a tasty meal.', 'C:\\xampp\\htdocs\\uploads\\fried_rice.jpg'),
(25, 'Greek Gyros', 'Gyros, Greek', 0, 1, 60, 'lamb, pita bread, yogurt, tomatoes, onions', 5, '1. Grill lamb. 2. Fill pita with lamb, yogurt, and veggies. 3. Enjoy your gyro.', 'C:\\xampp\\htdocs\\uploads\\gyros.jpg'),
...
--
-- Zrzut danych tabeli `recipe_category`
--
...
CREATE TABLE `users` (
  ...
  `image_path` text NOT NULL DEFAULT '../uploads/default_user.png'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'user1@example.com', 'User1', '$2y$10$UwLJsc29TNVDfEZQWSQfG.hHqP9L7GWnwoHSSDAdrcBQXgZZW6jxO', 1, 0, 'C:\\xampp\\htdocs\\uploads\\user1.jpg'),
(2, 'user2@example.com', 'User2', '$2y$10$vJ.LkXH7oH8K4uLM5xjWhuEJ4MJ9e.2B5vl1DQz8HTcgivmU1/EEu', 0, 1, 'C:\\xampp\\htdocs\\uploads\\User2.jpg'),
(3, 'user3@example.com', 'User3', '$2y$10$S/WZx5fv92VqyyibwhfHSOWVyvD5aWRDhQHPdp9QdYzB47CzRWviK', 1, 1, 'C:\\xampp\\htdocs\\uploads\\User3.jpg'),
(4, 'user4@example.com', 'User4', '$2y$10$6CZYd3dx9WQftuHIZ69P2e2Hws/zleUSbeq9B/tLxWwaj4M/8gADG', 0, 0, 'C:\\xampp\\htdocs\\uploads\\User4.jpg'),
(5, 'user5@example.com', 'User5', '$2y$10$KOVedU16G7TImiUNN7RQSOi0OMH0NOCeIUnz.ZUCxD1ugw6y/Q8gO', 1, 1, 'C:\\xampp\\htdocs\\uploads\\User5.jpg'),
(6, 'user6@example.com', 'User6', '$2y$10$9ETrbnEdNvdrP4qo9Wf5kOxMrExujdsomjUEYQzT.1DKE5/yy0muG', 0, 0, 'C:\\xampp\\htdocs\\uploads\\User6.jpg'),
(22, 'email@gmail.com', 'User1234561', '$2y$10$D6CuBrWz9WHfHpra057kDuoDL3wE6q4zZExRAWIRoOt8Eo/ak84Fe', NULL, NULL, ''),
(30, 'thomas@email.com', 'Tom1', 'password', 1, 0, 'C:\\xampp\\htdocs\\uploads\\User7.jpg'),
(31, 'baxtereq@gmail.com', 'baxtereq', '$2y$10$UFoPd98pPD6v2hJ8.Ib.mOyx/fj3eAvt4ktRqrxLmTQAWYjdLvic2', 0, 0, '');
...
--
-- Zrzut danych tabeli `user_preferences`
--
