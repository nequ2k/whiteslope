    ...
    <div id="right" class="col-xs-12 col-sm-8 col-md-6 col-lg-6">
        <section class="col-xs-12 col-sm-8 col-md-6 col-lg-8">
            ...
            <form action="../Includes/signup_includes.php" method = "post">
                ...
                <label class="red" for="login"><?php if(isset($_GET['usernameTakenErr'])) echo "Login already taken"; ?></label>


                <label for="password">Password</label>
                <input name="password" id="password" type="password" required="">
                <label class="red" for="password"><?php if(isset($_GET['invalidpasswordErr'])) echo "Password must be minimum 8 characters long and have uppercase letters, lowercase letters, numbers and symbols"; ?></label>

                <label for="confirm_password">Confirm Password</label>
                <input name="confirm_password" id="confirm_password" type="password" required="">
                <label class="red" for="confirm_password"><?php if(isset($_GET['password!matchErr'])) echo "Passwords don`t match"; ?></label>
